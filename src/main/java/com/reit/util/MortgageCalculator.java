...
public class MortgageCalculator {
	 ...
	 */
	public static void displayMonthlyBalance(int loanAmount, int termInYears, double interestRate,
	...
	public static void main(String[] args) {
		...
		displayMonthlyBalance(loanAmount, termInYears, interestRate, monthlyPayment);
	}
